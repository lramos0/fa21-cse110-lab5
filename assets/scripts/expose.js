...
function init() {
  ...
  var aud = expose.querySelector("audio");
  ...
  var button_play_sound = expose.querySelector("button");
    button_play_sound.addEventListener('click', function(){
      aud.play();
    });
    if(selection.value == "party-horn"){
      ...
      //Not sure about the JSConfetti part
    }
}
